...
const CATALOG = [
  {
    ...
    semesters: [
      ...
      { id: 'sem-02', label: 'Semester 2', exams: [
        ...
        { id: 'm-10-13', label: 'Module 10-13 Quiz' },
        { id: 'm-14-16',label: 'Module 14–16 Quiz' },
        { id: 'final',  label: 'Final exam' },
      ]},
      { id: 'sem-03', label: 'Semester 3', exams: [
        { id: 'm-1-2',  label: 'Module 1-2 Quiz', available: true, count: 46 },
        { id: 'm-1-5',  label: 'Module 1–5 Quiz' },
        { id: 'm-6-8',  label: 'Module 6–8 Quiz' },
        { id: 'm-9-12', label: 'Module 9–12 Quiz' },
        { id: 'm-13-14',label: 'Module 13–14 Quiz' },
