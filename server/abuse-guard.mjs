const DEFAULT_LIMITS = {
  ...
  verifyEmailIp: { limit: 40, windowMs: 15 * 60_000 },
  resendVerificationIp: { limit: 10, windowMs: 60 * 60_000 },
  resendVerificationEmail: { limit: 5, windowMs: 60 * 60_000 },
  forgotPasswordIp: { limit: 10, windowMs: 60 * 60_000 },
  forgotPasswordEmail: { limit: 5, windowMs: 60 * 60_000 },
  resetPasswordIp: { limit: 30, windowMs: 60 * 60_000 },
  accountDeleteUser: { limit: 3, windowMs: 60 * 60_000 },
  accountDeletionCancelIp: { limit: 10, windowMs: 60 * 60_000 },
  accountDeletionCancelEmail: { limit: 5, windowMs: 60 * 60_000 },
